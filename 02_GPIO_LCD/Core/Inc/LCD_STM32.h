...
#define E_ON   HAL_GPIO_WritePin(GPIOB, EN_Pin, 1);
#define E_OFF  HAL_GPIO_WritePin(GPIOB, EN_Pin, 0);

#define RS_ON HAL_GPIO_WritePin(GPIOB, RS_Pin, 1);
#define RS_OFF HAL_GPIO_WritePin(GPIOB, RS_Pin, 0);

#define D4_ON  HAL_GPIO_WritePin(GPIOC, D4_Pin, 1);
#define D4_OFF HAL_GPIO_WritePin(GPIOC, D4_Pin, 0);

#define D5_ON HAL_GPIO_WritePin(GPIOB, D5_Pin, 1);
#define D5_OFF HAL_GPIO_WritePin(GPIOB,D5_Pin, 0);
