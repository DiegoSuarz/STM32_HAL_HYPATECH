...
//IC
uint16_t captures[2];
uint16_t diff_captures;
float frequency;
volatile uint8_t capture_done = 0;

//OC
volatile uint16_t CH1_FREQ; //carga para 1500hz
volatile uint16_t CH2_FREQ;  //carga para 20000hz
...
int main(void)
{
  ...
  //Configuracion OUTPUT CAPTURE
  /*
   Formula para calcular la frecuencia de conmutacion de modo OUTPUT CAPTURE

  pulse = FOSC/FreqOC

  Para el canal 1: se quiere configurar la frecuencia a 1500 hz:

  pulse = 16x10^6/1500
  pulse =  10666.6
  pulse = 10667

  Para el canal 1: se quiere configurar la frecuencia a 20000 hz:
  ...
  */
  ...
  while (1)
  {
	  //codigo del while solo sirve para el periferico IC
	  if(capture_done == 2){
