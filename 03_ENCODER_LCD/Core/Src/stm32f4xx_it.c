...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define Encoder_LIMITEMAX	1000
#define Encoder_LIMTEMIN	0
#define Encoder_INCREMENTO	10
volatile uint16_t valor_actual = 0, valor_inicial = 0, contador_posicion=0;
/* USER CODE END PD */
